...
class ContainerApiGenerator extends GeneratorCommand implements ComponentsGenerator
{
     ...
     * @var string
     */
    protected $name = 'hive:generate:container:api';
     ...
     * @var string
     */
    protected $description = 'Create a Container for HiveApi from scratch (API Part)';
    ...
    public function getUserInputs()
    {
        ...
        $this->call('hive:generate:transformer', [
            '--container'   => $containerName,
